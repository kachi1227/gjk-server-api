...
class Result {
	...
	private $registrationId, $messageId, $canonicalRegistrationId, $errorCode;

	function __construct($registrationId, $messageId, $canonicalRegistrationId, $errorCode) {
	...
	*/
	 ...
	 */
	function getCanonicalRegistrationId() {
